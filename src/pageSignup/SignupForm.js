...
// Inline SVG components for reuse
const EmailIcon = () => (
  ...
  return (
    <div className="session">
      ...
      <form action="" className="log-in" autoComplete="off">
        <h4><span>IKY</span> web </h4>
        <p>Sign up now, and get acces to our site web :</p>
        <div className="floating-label">
          <input placeholder="First name" type="firstname" name="firstname" id="firstname" autoComplete="off" />
          <label htmlFor="email">First name:</label>
        </div>
        <div className="floating-label">
          <input placeholder="Lastname" type="lastname" name="lastname" id="lastname" autoComplete="off" />
        ...
        <div className="floating-label">
          <input placeholder="Conforim" type="password" name="password" id="password" autoComplete="off" />
